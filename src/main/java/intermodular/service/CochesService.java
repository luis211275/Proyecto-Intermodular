...
import intermodular.dao.impl.CochesDAOImpl;
...
public class CochesService {
  ...
  public void comprarCoche(int idCoche, int idComprador) throws CochesException, intermodular.exception.FacturasException {
    CocheResponse coche = obtenerCochePorId(idCoche);
